...
<body>
  <nav>
    <div class="container-fluid nav-wrapper #00838f crimson darken-3 z-depth-5">
      <a href="index.php" class="brand-logo"><img src="https://www.flaticon.com/svg/vstatic/svg/2830/2830289.svg?token=exp=1617713396~hmac=6bc0b844ad94f982ec63928f30b03748" style="height:65px;width:55px" /></a>
  ...
  <div class="center head mt-0">
    <h3><b><span><img src="https://www.flaticon.com/svg/vstatic/svg/2830/2830289.svg?token=exp=1617713396~hmac=6bc0b844ad94f982ec63928f30b03748" style="height:65px;width:55px" /></span>SPARK BANK</b></h3>
  </div>
  <!---3 col start-->
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/bank.jpg" style="height: 180px; width: 300px">
            </div>
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            ...
            <br />
            <h5><b>Welcome to Spark Bank !</b></h5>
            <br />
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/history.png" style="height: 200px; width: 360px">
            </div>
